...
import Portal from './helper-components/Portal'
import { quillItems } from './helpers';

// Refactor out the old editor/toolbar with the new and transfer over functionality to the new RichText component
