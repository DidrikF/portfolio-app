...
// The goal is to just render a RichText component :)
    ...
    render() {
        return (
            <div>
                ...
                <label>Show</label> {/* add a checkbox next to the project in the side navigation */}
                <input name="show" type="checkbox" checked={this.state.show} onChange={this.handleInputChange} />

                <label>Description</label> {/* maybe not include this */}
